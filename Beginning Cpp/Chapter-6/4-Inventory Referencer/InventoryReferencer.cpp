...
string &refToElement(vector<string> &inventory, int index);
...
int main()
{
    ...
    string &rStr2 = refToElement(inventory, 2);
    string str = rStr2;
    ...
    cout << "Change the copied string object without altering the inventory...\n";
    rStr2 = "Letter";
    str = "Mushroom";
