...
// Excersise add friend method to the Player class
// Excersise add tail pointer to the game lobby
...
{
    Player *nextPlayer = aPlayer.GetNext();

    if (nextPlayer != 0)
    {
        cout << "Player : " << aPlayer.m_Name << ", Next Player: " << nextPlayer->GetName();
    }
    else
    {
        cout << "Last player : " << aPlayer.m_Name;
    }
...
int main()
{
    ...
    do
    {
        ...
        cout << "2 - Remove a player from thee lobby.\n";
